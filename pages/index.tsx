...
export default function Home() {
  ...
  const [messageState, setMessageState] = useState<{ messages: Message[], pending?: string, history: [string, string][] }>({
    messages: [{
      "message": "Hi, I'm an AI assistant. How can I help you?",
      "type": "apiMessage"
    }],
    history: []
  });
  ...
  return (
    <>
      <Head>
        {/* <!-- Primary Meta Tags --> */}
        <title>Ashok Pudasaini: Chatbot</title>
        <meta name="title" content="Ashok Pudasaini: Chatbot" />
        ...
        <meta property="og:title" content="Ashok Pudasaini: Chatbot" />
        ...
        <meta property="twitter:title" content="Ashok Pudasaini: Chatbot" />
      ...
      <div className={styles.topnav}>
        <div>
          <Link href="/"><h1 className={styles.navlogo}>Ashok Pudasaini: Chatbot</h1></Link>
        </div>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.center}>
          ...
          <div className = {styles.footer}>
            <p> Built by <a href="https://twitter.com/ashokpds" target="_blank" rel="noreferrer">
                Emir Amanbekov
